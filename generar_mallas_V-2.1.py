...
def build_html(program_title, program_code, courses, area_vars):
    ...
    # Usamos marcadores "seguros" en vez de .format para no chocar con { } de CSS/JS
...
<style>
  ...
  .grid{display:grid; gap:14px; grid-template-columns: repeat(10, minmax(180px, 1fr)); align-items:start; padding:16px}
